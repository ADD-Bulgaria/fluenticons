...
export default function FlashPlayIcon({ 
  ...
  const gradientId = 'flashplayicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
