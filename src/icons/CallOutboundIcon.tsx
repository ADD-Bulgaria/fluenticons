...
export default function CallOutboundIcon({ 
  ...
  const gradientId = 'calloutboundicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
