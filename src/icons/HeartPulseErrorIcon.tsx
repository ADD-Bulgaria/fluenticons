...
export default function HeartPulseErrorIcon({ 
  ...
  const gradientId = 'heartpulseerroricon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
