...
export default function ChatVideoIcon({ 
  ...
  const gradientId = 'chatvideoicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
