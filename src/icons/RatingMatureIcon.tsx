...
export default function RatingMatureIcon({ 
  ...
  const gradientId = 'ratingmatureicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
