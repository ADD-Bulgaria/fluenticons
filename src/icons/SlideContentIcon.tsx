...
export default function SlideContentIcon({ 
  ...
  const gradientId = 'slidecontenticon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
