...
export default function MailAddIcon({ 
  ...
  const gradientId = 'mailaddicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
