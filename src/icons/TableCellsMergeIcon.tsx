...
export default function TableCellsMergeIcon({ 
  ...
  const gradientId = 'tablecellsmergeicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
