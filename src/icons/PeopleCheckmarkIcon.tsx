...
export default function PeopleCheckmarkIcon({ 
  variant = 'regular',
  className,
  size = '1em',
  color,
  ...
  const gradientId = 'peoplecheckmarkicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
