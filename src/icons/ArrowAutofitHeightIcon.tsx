...
const svgContent = {
  'filled': `<path d="m12.952 5.898.084-.098 2.355-2.357c.179-.273.504-.443.86-.443.323 0 .619.14.805.368l.005.007.046.064L19.465 5.8l.085.098.005.008a1 1 0 0 1 .01 1.177l-.006.008-.099.117-.106.091-.007.006a1 1 0 0 1-1.177.01l-.009-.007-.11-.093-.801-.801v3.19l-.008.108-.002.01c-.072.463-.51.778-.99.778s-.918-.315-.99-.779l-.002-.01-.008-.108V6.414l-.8.8-.097.085-.008.006a1 1 0 0 1-1.399-1.4zM4 6.492a2.5 2.5 0 0 1 2.5-2.5h4a1 1 0 1 1 0 2h-4a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 .5.5h4a1 1 0 1 1 0 2h-4a2.5 2.5 0 0 1-2.5-2.5zm10.453 10.294-.098-.085-.008-.006a1 1 0 0 0-1.302 1.511l2.347 2.35c.18.274.505.444.86.444.357 0 .682-.17.861-.444l2.354-2.356.085-.098.005-.008a1 1 0 0 0-.096-1.302l-.007-.006-.098-.085-.007-.006a1 1 0 0 0-1.303.097l-.794.794v-3.19l-.008-.108-.002-.01c-.072-.463-.51-.778-.99-.778-.52 0-1 .376-1 .906v3.18z"/>`,
...
export default function ArrowAutofitHeightIcon({ 
  variant = 'regular',
  className,
  size = '1em',
  color,
  ...
  const gradientId = 'arrowautofitheighticon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
