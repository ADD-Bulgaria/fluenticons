...
export default function PanelLeftTextAddIcon({ 
  ...
  const gradientId = 'panellefttextaddicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
