...
export default function CircleSparkleIcon({ 
  ...
  const gradientId = 'circlesparkleicon_gradient';
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
